...
func (_m *Querier) GetChannelSettingsForAPI(ctx context.Context, id int32) (models.GetChannelSettingsForAPIRow, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Querier) PatchChannelSettings(ctx context.Context, arg models.PatchChannelSettingsParams) (models.Channel, error) {
	ret := _m.Called(ctx, arg)
...
func (_m *Querier) UpdateAPIKeyIPRestrictions(ctx context.Context, arg models.UpdateAPIKeyIPRestrictionsParams) error {
	ret := _m.Called(ctx, arg)
...
func (_m *Querier) UpdateAllChannelSettings(ctx context.Context, arg models.UpdateAllChannelSettingsParams) (models.Channel, error) {
	ret := _m.Called(ctx, arg)
