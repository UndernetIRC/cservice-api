...
// AddMultipleUserRoles provides a mock function with given fields: ctx, arg
func (_m *Querier) AddMultipleUserRoles(ctx context.Context, arg models.AddMultipleUserRolesParams) error {
	ret := _m.Called(ctx, arg)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.AddMultipleUserRolesParams) error); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Error(0)
	}
