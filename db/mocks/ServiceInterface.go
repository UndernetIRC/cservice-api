...
func (_m *ServiceInterface) CreateAPIKey(ctx context.Context, arg models.CreateAPIKeyParams) (models.ApiKey, error) {
	ret := _m.Called(ctx, arg)
...
func (_m *ServiceInterface) DeleteAPIKey(ctx context.Context, iD int32, lastUpdated int32) error {
...
func (_m *ServiceInterface) GetAPIKey(ctx context.Context, id int32) (models.ApiKey, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ServiceInterface) GetAPIKeyByHash(ctx context.Context, keyHash string) (models.ApiKey, error) {
...
func (_m *ServiceInterface) GetAPIKeysExpiringSoon(ctx context.Context, expiresAt pgtype.Int4) ([]models.ApiKey, error) {
	ret := _m.Called(ctx, expiresAt)
...
// GetChannelSettingsForAPI provides a mock function with given fields: ctx, id
func (_m *ServiceInterface) GetChannelSettingsForAPI(ctx context.Context, id int32) (models.GetChannelSettingsForAPIRow, error) {
	ret := _m.Called(ctx, id)

	if len(ret) == 0 {
		panic("no return value specified for GetChannelSettingsForAPI")
	}

	var r0 models.GetChannelSettingsForAPIRow
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int32) (models.GetChannelSettingsForAPIRow, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int32) models.GetChannelSettingsForAPIRow); ok {
		r0 = rf(ctx, id)
	} else {
		r0 = ret.Get(0).(models.GetChannelSettingsForAPIRow)
	}
...
func (_m *ServiceInterface) ListAPIKeys(ctx context.Context) ([]models.ApiKey, error) {
	ret := _m.Called(ctx)
...
// PatchChannelSettings provides a mock function with given fields: ctx, arg
func (_m *ServiceInterface) PatchChannelSettings(ctx context.Context, arg models.PatchChannelSettingsParams) (models.Channel, error) {
	ret := _m.Called(ctx, arg)

	if len(ret) == 0 {
		panic("no return value specified for PatchChannelSettings")
	}

	var r0 models.Channel
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.PatchChannelSettingsParams) (models.Channel, error)); ok {
		return rf(ctx, arg)
	}
	if rf, ok := ret.Get(0).(func(context.Context, models.PatchChannelSettingsParams) models.Channel); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Get(0).(models.Channel)
	}

	if rf, ok := ret.Get(1).(func(context.Context, models.PatchChannelSettingsParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ServiceInterface) UpdateAPIKeyScopes(ctx context.Context, arg models.UpdateAPIKeyScopesParams) error {
	ret := _m.Called(ctx, arg)
...
// UpdateAllChannelSettings provides a mock function with given fields: ctx, arg
func (_m *ServiceInterface) UpdateAllChannelSettings(ctx context.Context, arg models.UpdateAllChannelSettingsParams) (models.Channel, error) {
	ret := _m.Called(ctx, arg)

	if len(ret) == 0 {
		panic("no return value specified for UpdateAllChannelSettings")
	}

	var r0 models.Channel
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.UpdateAllChannelSettingsParams) (models.Channel, error)); ok {
		return rf(ctx, arg)
	}
	if rf, ok := ret.Get(0).(func(context.Context, models.UpdateAllChannelSettingsParams) models.Channel); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Get(0).(models.Channel)
	}

	if rf, ok := ret.Get(1).(func(context.Context, models.UpdateAllChannelSettingsParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
