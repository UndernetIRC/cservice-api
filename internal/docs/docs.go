...
const docTemplate = `{
        ...
        "/channels/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/channel.GetChannelSettingsResponse"
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Complete channel settings",
                        "name": "settings",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/channel.FullSettingsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/channel.UpdateChannelSettingsResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request data",
                    ...
                    "403": {
                        "description": "Insufficient permissions - includes denied_settings in details when specific settings are denied",
                        "schema": {
                            "$ref": "#/definitions/errors.ErrorResponse"
                        }
                    },
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Partial channel settings to update",
                        "name": "settings",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/channel.PartialSettingsRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "channel.GetChannelSettingsResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
                ...
                "settings": {
                    "$ref": "#/definitions/channel.ResponseSettings"
                },
                "updated_at": {
                    "type": "integer"
                }
        ...
        "channel.PartialSettingsRequest": {
            "type": "object",
            "properties": {
                "autojoin": {
                    "type": "boolean"
        ...
        "channel.UpdateChannelSettingsResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
